...
import { Sparkles, LayoutDashboard, Calendar, Briefcase, Users, LogOut, Menu, X } from 'lucide-react'
...
const navItems = [
  ...
  { href: '/admin/dashboard/servicios', label: 'Servicios', icon: Briefcase },
  { href: '/admin/dashboard/barberos', label: 'Técnicas', icon: Users },
]
      ...
      <aside className="hidden md:flex w-56 flex-col border-r border-[hsl(0_0%_10%)] fixed inset-y-0 left-0 bg-[hsl(0_0%_4.5%)]">
        <div className="p-4 border-b border-[hsl(0_0%_10%)]">
          <Link href="/" className="flex items-center gap-2 group">
            ...
            <div>
              <p className="text-sm font-bold leading-none">Nail Studio</p>
              <p className="text-[10px] text-[hsl(0_0%_45%)] mt-0.5">Panel dueño</p>
            </div>
          </Link>
        </div>
